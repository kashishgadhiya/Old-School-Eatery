    ...
    return(
        ...
        <section className="lg:mt-4 mt-28  mx-50    pb-56 lg:pb-8 ">
            ...
            <div className='my-4 text-center font-semibold'>
                User created.<br></br>Now you can login <Link href={'/login'} className='underline'> Login &raquo;</Link>
          ...
          onClick={() => signIn('google', {callbackUrl: '/'})}
            ...
            Login with google
                ...
                <div className='my-4  text-center text-gray-700 border-t pt-4'>
                    Existing account ? <Link href={'/login'} className='font-semibold underline'> Login here &raquo;</Link>
                </div>
